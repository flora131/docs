...
Each agent gets its own configuration directory (`.claude/`, `.opencode/`, `.github/`), skills, and context files — all managed by Atomic. See [agent-specific files](/build/configuration/agent-files).
...
<Columns cols={2}>
  <Card title="Claude Code" icon="anthropic" href="/reference/agents/claude-code/cli/cli-reference">
    Claude Code CLI reference.
  </Card>
  <Card title="OpenCode" icon="terminal" href="/reference/agents/opencode/server">
    OpenCode server reference.
  </Card>
  <Card title="GitHub Copilot CLI" icon="github" href="/reference/agents/copilot-cli/usage">
    Copilot CLI usage reference.
  </Card>
  <Card title="Permissions" icon="shield-halved" href="/get-started/concepts/permissions">
