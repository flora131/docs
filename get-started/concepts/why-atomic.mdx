...
Atomic ships two surfaces that share one runtime — see [CLI vs SDK](/get-started/concepts/cli-vs-sdk):

<Columns cols={2}>
  <Card title="CLI" icon="terminal" href="/reference/cli/commands">
