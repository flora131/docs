...
- [Slash Commands](/agents/claude-code/agent-sdk/guides/slash-commands) - Using slash commands in the SDK
- [Subagents](/agents/claude-code/agent-sdk/guides/subagents) - Working with specialized agents
- [Skills](/agents/claude-code/agent-sdk/guides/skills) - Using Agent Skills
