...
For complete API documentation, see the [TypeScript SDK reference](/agents/claude-code/agent-sdk/sdk-references/typescript) and [Python SDK reference](https://docs.claude.com/en/agent-sdk/python).
...
- **`query()` call:** one invocation of the SDK's `query()` function. A single call can involve multiple steps (Claude responds, uses tools, gets results, responds again). Each call produces one [`result`](/agents/claude-code/agent-sdk/sdk-references/typescript#sdk-result-message) message at the end.
...
Track these separately from `input_tokens` to understand caching savings. In TypeScript, these fields are typed on the [`Usage`](/agents/claude-code/agent-sdk/sdk-references/typescript#usage) object. In Python, they appear as keys in the [`ResultMessage.usage`](https://docs.claude.com/en/agent-sdk/python#result-message) dict (for example, `message.usage.get("cache_read_input_tokens", 0)`).

## Related documentation

- [TypeScript SDK Reference](/agents/claude-code/agent-sdk/sdk-references/typescript) - Complete API documentation
- [SDK Overview](/agents/claude-code/agent-sdk/overview) - Getting started with the SDK
- [SDK Permissions](/agents/claude-code/agent-sdk/guides/permissions) - Managing tool permissions
