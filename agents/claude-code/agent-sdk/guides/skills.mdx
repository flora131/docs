...
For more details on `settingSources`/`setting_sources`, see the [TypeScript SDK reference](/agents/claude-code/agent-sdk/sdk-references/typescript#setting-source) or [Python SDK reference](https://docs.claude.com/en/agent-sdk/python#setting-source).
...
### SDK Resources
- [Subagents in the SDK](/agents/claude-code/agent-sdk/guides/subagents): Similar filesystem-based agents with programmatic options
- [Slash Commands in the SDK](/agents/claude-code/agent-sdk/guides/slash-commands): User-invoked commands
- [SDK Overview](/agents/claude-code/agent-sdk/overview): General SDK concepts
