...
- **Programmatically**: use the `agents` parameter in your `query()` options ([TypeScript](/agents/claude-code/agent-sdk/sdk-references/typescript#agent-definition), [Python](https://docs.claude.com/en/agent-sdk/python#agent-definition))
...
- [SDK overview](/agents/claude-code/agent-sdk/overview): getting started with the Claude Agent SDK
