...
<Info>
For security hardening beyond basic sandboxing (including network controls, credential management, and isolation options), see [Secure Deployment](/agents/claude-code/agent-sdk/guides/secure-deployment).
</Info>
...
The SDK also supports [programmatic sandbox configuration](/agents/claude-code/agent-sdk/sdk-references/typescript#sandbox-settings) for command execution.
...
For self-hosted options (Docker, gVisor, Firecracker) and detailed isolation configuration, see [Isolation Technologies](/agents/claude-code/agent-sdk/guides/secure-deployment#isolation-technologies).
...
- [Secure Deployment](/agents/claude-code/agent-sdk/guides/secure-deployment) - Network controls, credential management, and isolation hardening
- [TypeScript SDK - Sandbox Settings](/agents/claude-code/agent-sdk/sdk-references/typescript#sandbox-settings) - Configure sandbox programmatically
- [Sessions Guide](/agents/claude-code/agent-sdk/core-concepts/sessions) - Learn about session management
- [Permissions](/agents/claude-code/agent-sdk/guides/permissions) - Configure tool permissions
- [Cost Tracking](/agents/claude-code/agent-sdk/guides/cost-tracking) - Monitor API usage
- [MCP Integration](/agents/claude-code/agent-sdk/guides/mcp) - Extend with custom tools
