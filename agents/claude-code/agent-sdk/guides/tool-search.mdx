...
Tool search applies to all registered tools, whether they come from remote MCP servers or [custom SDK MCP servers](/agents/claude-code/agent-sdk/guides/custom-tools). When using `auto`, the threshold is based on the combined size of all tool definitions across all servers.
...
- [Connect MCP servers](/agents/claude-code/agent-sdk/guides/mcp): Connect to external tools via MCP servers
- [Custom tools](/agents/claude-code/agent-sdk/guides/custom-tools): Build your own tools with SDK MCP servers
- [TypeScript SDK reference](/agents/claude-code/agent-sdk/sdk-references/typescript): Full API reference
