...
**Ready to build?** Follow the [Quickstart](/agents/claude-code/agent-sdk/quickstart) to create an agent that finds and fixes bugs in minutes.
...
<Tabs>
  <Tab title="Built-in tools">
    ...
    | **[AskUserQuestion](/agents/claude-code/agent-sdk/guides/user-input#handle-clarifying-questions)** | Ask the user clarifying questions with multiple choice options |
  ...
  <Tab title="Hooks">
    ...
    **Available hooks:** `PreToolUse`, `PostToolUse`, `Stop`, `SessionStart`, `SessionEnd`, `UserPromptSubmit`, and more.
    ...
    [Learn more about hooks →](/agents/claude-code/agent-sdk/guides/hooks)
  </Tab>
  <Tab title="Subagents">
    ...
    [Learn more about subagents →](/agents/claude-code/agent-sdk/guides/subagents)
  </Tab>
  <Tab title="MCP">
    ...
    [Learn more about MCP →](/agents/claude-code/agent-sdk/guides/mcp)
  </Tab>
  <Tab title="Permissions">
    ...
    <Note>
    For interactive approval prompts and the `AskUserQuestion` tool, see [Handle approvals and user input](/agents/claude-code/agent-sdk/guides/user-input).
    </Note>
    ...
    [Learn more about permissions →](/agents/claude-code/agent-sdk/guides/permissions)
  </Tab>
  <Tab title="Sessions">
    ...
    [Learn more about sessions →](/agents/claude-code/agent-sdk/core-concepts/sessions)
  </Tab>
</Tabs>
...
|---------|-------------|----------|
| [Skills](/agents/claude-code/agent-sdk/guides/skills) | Specialized capabilities defined in Markdown | `.claude/skills/*/SKILL.md` |
| [Slash commands](/agents/claude-code/agent-sdk/guides/slash-commands) | Custom commands for common tasks | `.claude/commands/*.md` |
| [Memory](/agents/claude-code/agent-sdk/guides/modifying-system-prompts) | Project context and instructions | `CLAUDE.md` or `.claude/CLAUDE.md` |
| [Plugins](/agents/claude-code/agent-sdk/guides/plugins) | Extend with custom commands, agents, and MCP servers | Programmatic via `plugins` option |
