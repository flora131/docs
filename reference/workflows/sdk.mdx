---
title: SDK
description: Reference documentation for sdk in Atomic.
---
...
The `Agent` class (from `@bastani/atomic`) handles the core LLM interaction. Access it via `session.agent`.
...
- Project extensions (`.atomic/extensions/`)
- Project skills:
  - `.atomic/skills/`
  - `.agents/skills/` in `cwd` and ancestor directories (up to git repo root, or filesystem root when not in a repo)
- Project prompts (`.atomic/prompts/`)
...
- Global skills:
  - `skills/` under `agentDir` (for example `~/.atomic/agent/skills/`)
  - `~/.agents/skills/`
...
Extensions are loaded by the `ResourceLoader`. `DefaultResourceLoader` discovers extensions from `~/.atomic/agent/extensions/`, `.atomic/extensions/`, and settings.json extension sources.
...
Extensions can register tools, subscribe to events, add commands, and more. See [extensions.md](/build/extend/extensions) for the full API.
...
> See [examples/sdk/06-extensions.ts](https://github.com/flora131/atomic/blob/main/packages/coding-agent/examples/sdk/06-extensions.ts) and [docs/extensions.md](/build/extend/extensions)
...
> See [examples/sdk/11-sessions.ts](https://github.com/flora131/atomic/blob/main/packages/coding-agent/examples/sdk/11-sessions.ts) and [Session Format](/reference/runtime/session-format)
...
1. Global: `~/.atomic/agent/settings.json`
2. Project: `<cwd>/.atomic/settings.json`
...
See [RPC documentation](/reference/runtime/rpc) for the JSON protocol.
...
For extension types, see [extensions.md](/build/extend/extensions) for the full API.
