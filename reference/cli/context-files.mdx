...
All three agents share the same skills directory (`.agents/skills/`) — Claude Code reads it through a `.claude/skills/` symlink, the others read it directly. See [agent-specific files](/build/configuration/agent-files).
