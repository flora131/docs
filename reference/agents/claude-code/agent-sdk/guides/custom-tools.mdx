...
description: "Define custom tools with the Agent SDK's in-process MCP server so Claude can call your functions and APIs."
icon: "wrench"
---
...
|:-------------------|:--------|
| Define a tool | Use [`@tool`](https://docs.claude.com/en/agent-sdk/python#tool) (Python) or [`tool()`](/reference/agents/claude-code/agent-sdk/sdk-references/typescript#tool) (TypeScript) with a name, description, schema, and handler. See [Create a custom tool](#create-a-custom-tool). |
...
| Scale to many tools | Use [tool search](/reference/agents/claude-code/agent-sdk/guides/tool-search) to load tools on demand. |

## Create a custom tool

A tool is defined by four parts, passed as arguments to the [`tool()`](/reference/agents/claude-code/agent-sdk/sdk-references/typescript#tool) helper in TypeScript or the [`@tool`](https://docs.claude.com/en/agent-sdk/python#tool) decorator in Python:
...
After defining a tool, wrap it in a server with [`createSdkMcpServer`](/reference/agents/claude-code/agent-sdk/sdk-references/typescript#create-sdk-mcp-server) (TypeScript) or [`create_sdk_mcp_server`](https://docs.claude.com/en/agent-sdk/python#create-sdk-mcp-server) (Python). The server runs in-process inside your application, not as a separate process.
...
See the [`tool()`](/reference/agents/claude-code/agent-sdk/sdk-references/typescript#tool) TypeScript reference or the [`@tool`](https://docs.claude.com/en/agent-sdk/python#tool) Python reference for full parameter details, including JSON Schema input formats and return value structure.
...
Every tool in this array consumes context window space on every turn. If you're defining dozens of tools, see [tool search](/reference/agents/claude-code/agent-sdk/guides/tool-search) to load them on demand instead.
...
See `ToolAnnotations` in the [TypeScript](/reference/agents/claude-code/agent-sdk/sdk-references/typescript#tool-annotations) or [Python](https://docs.claude.com/en/agent-sdk/python#tool-annotations) reference.
...
| allowed tools | Permission | Listed tools run without a permission prompt. Unlisted tools remain available; calls go through the [permission flow](/reference/agents/claude-code/agent-sdk/guides/permissions). |
...
- If your server grows to dozens of tools, see [tool search](/reference/agents/claude-code/agent-sdk/guides/tool-search) to defer loading them until Claude needs them.
- To connect to external MCP servers (filesystem, GitHub, Slack) instead of building your own, see [Connect MCP servers](/reference/agents/claude-code/agent-sdk/guides/mcp).
- To control which tools run automatically versus requiring approval, see [Configure permissions](/reference/agents/claude-code/agent-sdk/guides/permissions).

## Related documentation

- [TypeScript SDK Reference](/reference/agents/claude-code/agent-sdk/sdk-references/typescript)
- [Python SDK Reference](https://docs.claude.com/en/agent-sdk/python)
- [MCP Documentation](https://modelcontextprotocol.io)
- [SDK Overview](/reference/agents/claude-code/agent-sdk/overview)
