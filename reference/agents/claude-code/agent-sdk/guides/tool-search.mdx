...
description: "Scale your agent to thousands of tools by discovering and loading only what's needed, on demand."
...
For details on the underlying API mechanism, see [Tool search in the API](https://docs.claude.com/en/agents-and-tools/tool-use/tool-search-tool).
...
Tool search applies to all registered tools, whether they come from remote MCP servers or [custom SDK MCP servers](/reference/agents/claude-code/agent-sdk/guides/custom-tools). When using `auto`, the threshold is based on the combined size of all tool definitions across all servers.
...
- [Tool search in the API](https://docs.claude.com/en/agents-and-tools/tool-use/tool-search-tool): Full API documentation for tool search, including custom implementations
- [Connect MCP servers](/reference/agents/claude-code/agent-sdk/guides/mcp): Connect to external tools via MCP servers
- [Custom tools](/reference/agents/claude-code/agent-sdk/guides/custom-tools): Build your own tools with SDK MCP servers
- [TypeScript SDK reference](/reference/agents/claude-code/agent-sdk/sdk-references/typescript): Full API reference
- [Python SDK reference](https://docs.claude.com/en/agent-sdk/python): Full API reference
