...
description: "Secure Claude Code and Agent SDK deployments with isolation, credential management, and network controls."
icon: "lock"
---
...
- [Hosting the Agent SDK](/reference/agents/claude-code/agent-sdk/guides/hosting)
- [Handling permissions](/reference/agents/claude-code/agent-sdk/guides/permissions)
