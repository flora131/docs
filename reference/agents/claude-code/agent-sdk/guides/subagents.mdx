...
description: "Define and invoke subagents to isolate context, run tasks in parallel, and apply specialized instructions."
icon: "robot"
---
...
- **Programmatically**: use the `agents` parameter in your `query()` options ([TypeScript](/reference/agents/claude-code/agent-sdk/sdk-references/typescript#agent-definition), [Python](https://docs.claude.com/en/agent-sdk/python#agent-definition))
...
- [SDK overview](/reference/agents/claude-code/agent-sdk/overview): getting started with the Claude Agent SDK
