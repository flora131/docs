...
description: "Get type-safe, schema-validated JSON results from the Claude Agent SDK."
icon: "brackets-curly"
---
...
* [Custom tools](https://docs.claude.com/en/agent-sdk/custom-tools): give your agent custom tools to call during execution before returning structured output
