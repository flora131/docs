...
description: "Load custom plugins to extend Claude Code with commands, agents, skills, and hooks through the Agent SDK."
icon: "puzzle-piece"
---
...
- [Slash Commands](/reference/agents/claude-code/agent-sdk/guides/slash-commands) - Using slash commands in the SDK
- [Subagents](/reference/agents/claude-code/agent-sdk/guides/subagents) - Working with specialized agents
- [Skills](/reference/agents/claude-code/agent-sdk/guides/skills) - Using Agent Skills
