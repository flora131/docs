...
For comprehensive information about Skills, including benefits, architecture, and authoring guidelines, see the [Agent Skills overview](https://docs.claude.com/en/agents-and-tools/agent-skills/overview).
...
- [Agent Skills Best Practices](https://docs.claude.com/en/agents-and-tools/agent-skills/best-practices): Authoring guidelines and naming conventions
...
For more details on `settingSources`/`setting_sources`, see the [TypeScript SDK reference](/reference/agents/claude-code/agent-sdk/sdk-references/typescript#setting-source) or [Python SDK reference](https://docs.claude.com/en/agent-sdk/python#setting-source).
...
**Check the description**: Ensure it's specific and includes relevant keywords. See [Agent Skills Best Practices](https://docs.claude.com/en/agents-and-tools/agent-skills/best-practices#writing-effective-descriptions) for guidance on writing effective descriptions.
...
- [Agent Skills Overview](https://docs.claude.com/en/agents-and-tools/agent-skills/overview): Conceptual overview, benefits, and architecture
- [Agent Skills Best Practices](https://docs.claude.com/en/agents-and-tools/agent-skills/best-practices): Authoring guidelines for effective Skills
...
### SDK Resources
- [Subagents in the SDK](/reference/agents/claude-code/agent-sdk/guides/subagents): Similar filesystem-based agents with programmatic options
- [Slash Commands in the SDK](/reference/agents/claude-code/agent-sdk/guides/slash-commands): User-invoked commands
- [SDK Overview](/reference/agents/claude-code/agent-sdk/overview): General SDK concepts
- [TypeScript SDK Reference](/reference/agents/claude-code/agent-sdk/sdk-references/typescript): Complete API documentation
- [Python SDK Reference](https://docs.claude.com/en/agent-sdk/python): Complete API documentation
