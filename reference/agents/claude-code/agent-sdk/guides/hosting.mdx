...
description: "Deploy and host the Claude Agent SDK in production environments."
icon: "server"
---
...
<Info>
For security hardening beyond basic sandboxing (including network controls, credential management, and isolation options), see [Secure Deployment](/reference/agents/claude-code/agent-sdk/guides/secure-deployment).
</Info>
...
The SDK also supports [programmatic sandbox configuration](/reference/agents/claude-code/agent-sdk/sdk-references/typescript#sandbox-settings) for command execution.
...
For self-hosted options (Docker, gVisor, Firecracker) and detailed isolation configuration, see [Isolation Technologies](/reference/agents/claude-code/agent-sdk/guides/secure-deployment#isolation-technologies).
...
- [Secure Deployment](/reference/agents/claude-code/agent-sdk/guides/secure-deployment) - Network controls, credential management, and isolation hardening
- [TypeScript SDK - Sandbox Settings](/reference/agents/claude-code/agent-sdk/sdk-references/typescript#sandbox-settings) - Configure sandbox programmatically
- [Sessions Guide](/reference/agents/claude-code/agent-sdk/core-concepts/sessions) - Learn about session management
- [Permissions](/reference/agents/claude-code/agent-sdk/guides/permissions) - Configure tool permissions
- [Cost Tracking](/reference/agents/claude-code/agent-sdk/guides/cost-tracking) - Monitor API usage
- [MCP Integration](/reference/agents/claude-code/agent-sdk/guides/mcp) - Extend with custom tools
