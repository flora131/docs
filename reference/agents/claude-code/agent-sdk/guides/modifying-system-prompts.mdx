...
description: "Customize Claude's behavior by modifying system prompts using output styles, append mode, or a custom system prompt."
icon: "pen"
---
...
- [TypeScript SDK guide](/reference/agents/claude-code/agent-sdk/sdk-references/typescript) - Complete SDK usage guide
