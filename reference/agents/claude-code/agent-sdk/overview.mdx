...
description: "Build production AI agents with Claude Code as a library, using the same tools, agent loop, and context management."
icon: "code"
---
...
<Note>
The Claude Code SDK has been renamed to the Claude Agent SDK. If you're migrating from the old SDK, see the [Migration Guide](https://docs.claude.com/en/agent-sdk/migration-guide).
</Note>
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="play" href="https://docs.claude.com/en/agent-sdk/quickstart">
...
**Ready to build?** Follow the [Quickstart](/reference/agents/claude-code/agent-sdk/quickstart) to create an agent that finds and fixes bugs in minutes.
...
<Tabs>
  <Tab title="Built-in tools">
    ...
    | **[AskUserQuestion](/reference/agents/claude-code/agent-sdk/guides/user-input#handle-clarifying-questions)** | Ask the user clarifying questions with multiple choice options |
  ...
  <Tab title="Hooks">
    ...
    **Available hooks:** `PreToolUse`, `PostToolUse`, `Stop`, `SessionStart`, `SessionEnd`, `UserPromptSubmit`, and more.
    ...
    [Learn more about hooks →](/reference/agents/claude-code/agent-sdk/guides/hooks)
  </Tab>
  <Tab title="Subagents">
    ...
    [Learn more about subagents →](/reference/agents/claude-code/agent-sdk/guides/subagents)
  </Tab>
  <Tab title="MCP">
    ...
    [Learn more about MCP →](/reference/agents/claude-code/agent-sdk/guides/mcp)
  </Tab>
  <Tab title="Permissions">
    ...
    <Note>
    For interactive approval prompts and the `AskUserQuestion` tool, see [Handle approvals and user input](/reference/agents/claude-code/agent-sdk/guides/user-input).
    </Note>
    ...
    [Learn more about permissions →](/reference/agents/claude-code/agent-sdk/guides/permissions)
  </Tab>
  <Tab title="Sessions">
    ...
    [Learn more about sessions →](/reference/agents/claude-code/agent-sdk/core-concepts/sessions)
  </Tab>
</Tabs>
...
|---------|-------------|----------|
| [Skills](/reference/agents/claude-code/agent-sdk/guides/skills) | Specialized capabilities defined in Markdown | `.claude/skills/*/SKILL.md` |
| [Slash commands](/reference/agents/claude-code/agent-sdk/guides/slash-commands) | Custom commands for common tasks | `.claude/commands/*.md` |
| [Memory](/reference/agents/claude-code/agent-sdk/guides/modifying-system-prompts) | Project context and instructions | `CLAUDE.md` or `.claude/CLAUDE.md` |
| [Plugins](/reference/agents/claude-code/agent-sdk/guides/plugins) | Extend with custom commands, agents, and MCP servers | Programmatic via `plugins` option |
...
<Tabs>
  <Tab title="Agent SDK vs Client SDK">
    The [Anthropic Client SDK](https://docs.claude.com/en/api/client-sdks) gives you direct API access: you send prompts and implement tool execution yourself. The **Agent SDK** gives you Claude with built-in tool execution.
...
<CardGroup cols={2}>
  ...
  <Card title="TypeScript SDK" icon="code" href="https://docs.claude.com/en/agent-sdk/typescript">
    Full TypeScript API reference and examples
  </Card>
  <Card title="Python SDK" icon="code" href="https://docs.claude.com/en/agent-sdk/python">
