...
description: Reference documentation for json event stream mode in Atomic.
---
...
Events are defined in [`AgentSessionEvent`](https://github.com/flora131/atomic/blob/main/packages/coding-agent/src/core/agent-session.ts#L102):
...
Extended messages from [`packages/coding-agent/src/core/messages.ts`](https://github.com/flora131/atomic/blob/main/packages/coding-agent/src/core/messages.ts#L29):
