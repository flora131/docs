...
description: Reference documentation for session file format in Atomic.
---
...
Sessions can be removed by deleting their `.jsonl` files under `~/.atomic/agent/sessions/`.
...
Source on GitHub ([Atomic](https://github.com/flora131/atomic)):
- [`packages/coding-agent/src/core/session-manager.ts`](https://github.com/flora131/atomic/blob/main/packages/coding-agent/src/core/session-manager.ts) - Session entry types and SessionManager
- [`packages/coding-agent/src/core/messages.ts`](https://github.com/flora131/atomic/blob/main/packages/coding-agent/src/core/messages.ts) - Extended message types (BashExecutionMessage, CustomMessage, etc.)
...
### Base Message Types (from atomic-ai)
