...
Output groups workflows by source: built-ins first, then your registered custom workflows. Any broken entries (failed to load) appear in a trailing "skipped" section with the reason — see [registering workflows](/workflows/registering#broken-entries).
...
Detached mode is what you want for scripted / CI automation and long-running tasks. See [sessions](/concepts/sessions).
...
<Columns cols={2}>
  ...
  <Card title="Registering workflows" icon="bookmark" href="/workflows/registering">
