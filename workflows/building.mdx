...
The SDK runs on **[Bun](https://bun.sh/)** — not Node.js. You also need a multiplexer (tmux on macOS/Linux, psmux on Windows) and at least one authenticated agent CLI. See [installation](/installation).
...
<Columns cols={2}>
  ...
  <Card title="Register it" icon="bookmark" href="/workflows/registering">
