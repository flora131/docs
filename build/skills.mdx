---
title: Skills
description: Reference documentation for skills in Atomic.
---
...
Discovery rules:
- In `~/.atomic/agent/skills/` and `.atomic/skills/`, direct root `.md` files are discovered as individual skills
...
For project-level Claude Code skills, add to `.atomic/settings.json`:
...
```markdown
See the skill's own repository reference guide for details.
```
...
- [Atomic Skills](https://github.com/badlogic/pi-skills) - Web search, browser automation, Google APIs, transcription
