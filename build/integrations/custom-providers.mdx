...
description: Reference documentation for custom providers in Atomic.
---
...
models: [{
  ...
  // ...
  reasoning: true,
  thinkingLevelMap: {              // map Atomic levels to provider values; null hides unsupported levels
    minimal: null,
    low: null,
    medium: null,
    high: "default",
...
Credentials are persisted in `~/.atomic/agent/auth.json`:
