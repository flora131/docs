...
Skills are auto-discovered by every supported agent. All three agents share the same skill set via `.agents/skills/` — see [agent-specific files](/configuration/agent-files).
...
<Columns cols={2}>
  ...
  <Card title="Context files" icon="file-lines" href="/cli/context-files">
