---
title: "hostLocalWorkflows"
description: "The explicit handoff that makes your CLI atomic-dispatchable."
icon: "plug"
---
...
The two paths don't interfere: atomic's subcommands are token-gated and `process.exit` before your parser runs.
